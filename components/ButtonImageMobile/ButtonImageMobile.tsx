import styles from "./ButtonImageMobile.module.scss";

interface IButtonImageMobileProps {
  imageArray?: any[];
  href?: string;
}

// const ButtonImageMobile: React.FC<IButtonImageMobileProps> = () => {
//   return (
...
const ButtonImageMobile: React.FC<IButtonImageMobileProps> = ({imageArray = array, href="/sajtbygget"}) => {
