...
const TabList: React.FC<ITabListProps> = ({ knowledge, title, dark }) => {
    ...
    const handleClick = useMemo(() => ((id: number) => {
    ...
    const knowledgeTabs = useMemo(() => knowledge.map((item, index) => (
        ...
        <div
            ...
            <div
                ...
                <ul className={styles['TabList__List']}>
                    {!!knowledge.length && knowledgeTabs}
                </ul>
            </div>
            <div
